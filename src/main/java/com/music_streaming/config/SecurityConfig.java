...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://10.0.2.2:8080","http://10.0.2.2","http://76.38.163.141:8080", "http://localhost:8080","http://127.0.0.1:8080","http://music-streaming-backend-uh0v.onrender.com/") // Emulator URL
